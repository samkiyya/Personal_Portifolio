...
themeToggle.addEventListener("click", function () {
  ...
  if (themeToggle.classList.contains("active")) {
    themeLink.href = "style.css"; // Load dark mode CSS file
    document.querySelector(".toggle-label").textContent = "Dark Mode"; // Update toggle label
  } else {
    themeLink.href = "black.css"; // Load default mode CSS file
    document.querySelector(".toggle-label").textContent = "Night Mode"; // Update toggle label
  }
});
